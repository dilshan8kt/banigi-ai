          ...
          <div className="dash_CustomDesginFirst">
            <div>
              ...
              <div className="dash_CustomDesign_exam_btn">
                <button onClick={openRoomTypeExample}>
                  Example{" "}
                  <svg
                    width="10"
                    height="18"
              ...
              {showRoomTypeExample && (
                <div className="dash_customDesign_exam">
                  <p
            ...
            <div>
              ...
              <div className="dash_CustomDesign_exam_btn">
                <button onClick={openAvoidThingsExample}>
                  Example{" "}
                  <svg
                    width="10"
                    height="18"
            ...
            <div className="ExteriorDesignFile">
              {file.length == 0 ? (
                <span>
                  ...
                  Tap to upload Custom image Or <br />
                  Drag Image here direclty
                </span>
              ) : (
