...
const CustomDesign = () => {
  ...
  return (
    <>
      <div className="dash_CustomDesign">
        <h3>Custom Design</h3>

        <div className="dash_CustomDesignForm">

          <div className="dash_CustomDesginFirst">
            <div>
              <div className="dash_roomType_form">
              ...
              <div className="dash_CustomDesign_exam_btn">
                <button onClick={openRoomTypeExample}>Example <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.25 1.5L8.75 9L1.25 16.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                </button>
              </div>

              {showRoomTypeExample && <div className="dash_customDesign_exam">
                <p>Beautiful classic bedroom with the colors of gold, purple and grey.</p>
                <p>Beautiful Scandinavian living room with colors of white and beige, modular furniture with cotton textiles.</p>
              </div>}
            ...
            <div>
              ...
              <div className="dash_avoidThing_form">
              ...
              <div className="dash_CustomDesign_exam_btn" >
                <button onClick={openAvoidThingsExample}>Example <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.25 1.5L8.75 9L1.25 16.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                </button>
              </div>

              {showAvoidThingsExample && <div className="dash_customDesign_exam">
            ...
            <div className="ExteriorDesignFile">
              ...
              >
                ...
                <path
                  ...
                  fill="#C79952"
                />
              </svg>Tap to upload Custom image Or  <br />Drag Image here direclty</span> : <img src={file} alt="" className='uploadedImage' />
              }
